...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $enr = $_POST["enr"];
    if (empty($enr)) {
        echo '<script type="text/javascript">alert("Enrollment Number is required."); window.location.href="login.php"; </script>';
    }
    exit();
}
?>
            ...
            <div id="form-container">
                <form id="contactForm" method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="custom-form">
                    <div class="input-group">
                        ...
                        <input id="enr" type="number" placeholder="Enter the Enrollment Number*" name="enr" required />
                    </div>
                    <div class="text-center"><button id="submitButton" type="submit">Check</button></div>
                </form>
            </div>
            <div id="result"></div>
            <div id="academicrecords"></div>
        </div>
    </section>
    <footer class="footer">
